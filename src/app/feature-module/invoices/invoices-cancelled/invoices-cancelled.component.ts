...
export class InvoicesCancelledComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.cancelledInvoices.map((res: any, index: number) => {
    ...
    this.dataSource = new MatTableDataSource<any>(this.cancelledInvoicesList);
  ...
  public sortData(sort: Sort) {
    ...
    if (!sort.active || sort.direction === '') {
      ...
      this.cancelledInvoicesList = data.sort((a: any, b: any) => {
