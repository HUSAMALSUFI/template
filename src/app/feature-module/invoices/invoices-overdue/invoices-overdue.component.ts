...
export class InvoicesOverdueComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.overdueInvoices.map((res: any, index: number) => {
    ...
    this.dataSource = new MatTableDataSource<any>(this.overdueInvoicesList);
  ...
  public sortData(sort: Sort) {
    ...
    if (!sort.active || sort.direction === '') {
      ...
      this.overdueInvoicesList = data.sort((a: any, b: any) => {
