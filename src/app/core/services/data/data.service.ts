      ...
      menu: [
        {
          ...
          base: 'dashboard',
          subMenus: [
            { menuValue: 'Admin Dashboard', route: routes.main, base: 'main' },
            { menuValue: 'Teacher Dashboard', route: routes.teacher, base: 'teacher' },
            { menuValue: 'Student Dashboard', route: routes.student, base: 'student' },
          ],
        },
        {
          menuValue: 'Students',
          ...
          base: 'students',
          subMenus: [
            { menuValue: 'Student List', route: routes.studentlist, base: 'students-list' },
            { menuValue: 'Student View', route: routes.studentview, base: 'students-details' },
            { menuValue: 'Student Add', route: routes.studentsadd, base: 'students-add' },
          ],
        },
        {
          menuValue: 'Demo',
          ...
          base: 'demo',
          subMenus: [
            { menuValue: 'Demo List', route: routes.demolist, base:'demo-list' },
            { menuValue: 'Demo Add', route: routes.demoadd, base: 'demo-add' },
          ],
        },
        {
          menuValue: 'Teachers',
          ...
          base: 'teachers',
          subMenus: [
            { menuValue: 'Teachers Add', route: routes.teacheradd, base: 'teachers-add' },
          ],
        },
        {
          menuValue: 'Invoices',
          ...
          base: 'invoices',
          subMenus: [
            { menuValue: 'Invoices List', route: routes.invoiceslist, base: 'invoices-list', base2: 'invoices-paid', base3: 'invoices-overdue', base4: 'invoices-draft', base5: 'invoices-recurring', base6: 'invoices-cancelled' },
            { menuValue: 'Invoices Grid', route: routes.invoicesgrid, base: 'invoices-grid' },
            { menuValue: 'Add Invoices', route: routes.addinvoice, base: 'add-invoice' },
            { menuValue: 'Edit Invoices', route: routes.editinvoice, base: 'edit-invoice' },
            {
      ...
      menu: [
        {
          ...
          base: 'accounts',
          subMenus: [
            { menuValue: 'Fees Collection', route: routes.feescollection, base: 'fees-collection' },
          ],
        },
        {
          menuValue: 'Events',
        ...
        },
        {
          ...
          base: 'blog',
          subMenus: [
            { menuValue: 'All Blogs', route: routes.allblog, base: 'all-blog', base2: 'pending-blog', base3: 'blog-details' },
            { menuValue: 'Add Blog', route: routes.addblog, base: 'add-blog' },
          ],
        },
        {
          menuValue: 'Settings',
      ...
      menu: [
        {
          ...
          base: 'login',
          subMenus: [
            { menuValue: 'Login', route: routes.login, base: 'login' },
            { menuValue: 'Register', route: routes.register, base: 'register' },
            {
              menuValue: 'Forgot Password',
              route: routes.forgot_password,
              base: 'forgot-password',
            },
            { menuValue: 'Error', route: routes.error_screen, base: 'errorpage' },
          ],
        },
        {
